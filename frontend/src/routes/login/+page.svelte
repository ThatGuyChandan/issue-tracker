<script>
  ...
  async function login() {
    ...
    try {
      ...
      form.append('email', email); // Backend expects 'email'
    ...
    <div class="bg-white dark:bg-gray-800 py-8 px-6 shadow-xl rounded-xl border border-gray-100 dark:border-gray-700 transition-colors duration-200">
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
          ...
          <a href="/register" class="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200">
            Sign up here
          </a>
        </p>
      </div>
